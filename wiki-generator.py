...
def append_head_links(soup, webroot, stylesheet_path, script_path):
    ...
    meta_csp_tag = BeautifulSoup('<meta http-equiv="Content-Security-Policy" content="default-src \'self\' \'unsafe-inline\' https://avatars.githubusercontent.com http://fulltextsearch.norwayeast.azurecontainer.io">')
