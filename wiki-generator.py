...
def append_head_links(soup, webroot, stylesheet_path, script_path):
    ...
    meta_csp_tag = BeautifulSoup('<meta http-equiv="Content-Security-Policy" content="default-src \'self\' https://avatars.githubusercontent.com https://fulltextsearch.norwayeast.azurecontainer.io">')
